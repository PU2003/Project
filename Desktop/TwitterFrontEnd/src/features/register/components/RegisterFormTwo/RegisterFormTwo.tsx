 ...
 import { incrementStep } from "../../../../redux/slice/RegisterSlice";
     ...
     <div className="reg-step-two-container">
        <div className="reg-step-two-content">
            ...
            <p className="reg-step-two-policy">
                ...
                and <span className="reg-step-two-link">Cookie use</span>.Fwitter may use your contact information.including your email address and
                phone number for the purpose outline in our Privacy Policy.<span className="reg-step-two-link">Learn more</span>.               
            </p>
        </div>
